...
Следует обратить внимание, что файлы конфигурации кластера не сохранились в результате бекапа, так как они располагаются не в каталоге с данными, а в каталоге /etc. Если необходимо их тоже резервировать, то нужно сохранить их вручную.
