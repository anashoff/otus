...
Php-приложения обращиются к базе данных Postgres через прокси L4, через сокет 192.168.1.50:5432. 
