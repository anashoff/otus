...
В тексте метордического пособия есть разночтение с заданием в описании урока.
Там предлагается
...
Система сбора логов на стенде посторена на стеке Grafana-Loki-Alloy

1. Grafana Loki - сервер сбора и хранения логов
2. Grafana Alloy - новый универсальный коллектор логов, метрик, телеметрии и т.д. Alloy пришел на замену Promtail и Grafana Agent.
3. Grafana - средство визуализации 
